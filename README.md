...
| 🌤️ Weather Forecasting System | Java · API | Real-time weather monitoring |
| ☁️ College Admission Form Website | AWS S3 | Static website hosting and deployment |

---

# 💼 Internship & Training

### 🏭 NLC India Limited — Internship
...
| Achievement | Details |
|------------|---------|
| 🏎️ Indian Karting Race (IKR) 2024 | Powertrain Team Member – TN45 Motorsports |
| 🏁 Go Kart Design Challenge (GKDC) 2025 | Vehicle Design and Chassis Integration |
| ☁️ AWS Cloud Practitioner | Cloud Computing Certification |
| 🔧 Technical Workshops | Embedded Systems, PCB Design, Industrial Automation, Signal Processing |
...
<img src="https://capsule-render.vercel.app/api?type=waving&height=120&color=gradient&customColorList=3,12,14,16&section=footer" width="100%"/>
